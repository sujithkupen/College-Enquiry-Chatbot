...
import sqlite3
import aiml
from main import sentence as s
import random
import re
...
botName = "jntuhucej-bot"

@app.route("/")
def home():
    global botName
    session['sid'] = random.randint(1,10000)
...
GREETING = ['Hello! My name is jntuhucej-bot. I will try my best to provide you information related to our College!']
...
DEFAULT_RESPONSES = ["I did not get you! Pardon please!","I couldn't understand what you just said! Kindly rephrase"
                     ...
                     " queries regrading JNTUH UCEJ, your attendance and grades" ]
...
AUTH_KEYWORDS = ['login', 'cgpa', 'sgpa', 'grades', 'gpa','cgpa?','sgpa?','grades?','gpa?']
        ...
        if(len(inp.split(" "))==1):
            if(isKeyword(inp)==False):
                ...
                if(PWD_REQ==1):
                    ...
                    PWD_REQ = 0
                    return "I'll now be able to answer your GPA related queries if your credentials are valid! Otherwise you will have to provide your credentials again!"
