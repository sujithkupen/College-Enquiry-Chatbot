...
# Edited for the purpose of my project
...
class Kernel:
    ...
    def __init__(self):
        ...
        self._botPredicates = {}
        self.setBotPredicate("name", "jntuhucej-bot")
        # setting botmaster
        self.setBotPredicate("botmaster","botmaster")
        # setting other bot attributes
        self.setBotPredicate("family","snake(python)")
        self.setBotPredicate("species","Chat-bot")
        self.setBotPredicate("order","robot")
        self.setBotPredicate("age","3 months")
        self.setBotPredicate("class","Chat-bot")
        self.setBotPredicate("master","A group of intelligent people")
        self.setBotPredicate("birthplace","Jagtial")
        self.setBotPredicate("location","Jagtial")
        ...
        self.setBotPredicate("state","Telangana")
    ...
    def bootstrap(self, brainFile = None, learnFiles = [], commands = [],
        ...
        if self._verboseMode:
            pass#print( "Kernel bootstrap completed in %.2f seconds" % (time.perf_counter() - start) )
    ...
    def learn(self, filename):
        ...
        for f in glob.glob(filename):
            ...
            if self._verboseMode:
                pass#print( "done (%.2f seconds)" % (time.perf_counter() - start) ) #suppressing the output
